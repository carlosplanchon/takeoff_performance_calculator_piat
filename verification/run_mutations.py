#!/usr/bin/env python3
"""Mutation experiment for the takeoff performance calculator.

Introduces one deliberate defect at a time into the calculator and reports which
part of the test suite catches it. The result is the 37 out of 37 quoted in
...
than taken on faith.
    ...
    python3 verification/run_mutations.py C04 P01    # only these
...
minutes: 37 mutations, and for each one the suite runs once per layer.
"""
...
TEST_MARKER = '<script id="test-suite-script">'
...
# leading "!".
LAYERS = {
    "examples": "!/POH source data|getWindFactors|Invariants|Readiness/",
    "poh": "POH source data",
    "windtable": "getWindFactors",
